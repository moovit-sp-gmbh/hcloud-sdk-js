...
export const ScopeDependencies = {
    [Scope.HCLOUD_FULL]: [Object.values(Scope)[0]],
    [Scope.IDP_USER_READ]: [Scope.IDP_EMAIL_READ],
    ...
    [Scope.IDP_ORGANIZATION_ADMIN]: [Scope.IDP_USER_READ, Scope.IDP_ORGANIZATION_READ, Scope.IDP_ORGANIZATION_WRITE, Scope.IDP_ORGANIZATION_ADMIN],
