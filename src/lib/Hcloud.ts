...
export class HCloud {
    ...
    /**
     * Sets an optional compression format that the SDK shall request.
     * hint: br stands for brotli
     */
    setCompression(compression: ("gzip" | "deflate" | "br")[]): HCloud {
        this.axios.defaults.headers.common = {
            ...this.axios.defaults.headers.common,
            ...{ "Accept-Encoding": compression.join(", ") },
        };
        return this;
    }
